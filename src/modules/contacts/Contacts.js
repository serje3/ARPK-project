        ...
        <div className="contacts-content page grid">
            ...
            <div className="contacts_info_content flex">
                ...
                <div className="info flex">
                    ...
                    <p className="p">МТС: <strong>+7 (916) 782-71-23</strong></p>
                ...
                <div style={{ position: 'relative', overflow: 'hidden' }}><a
                    ...
                    style={{ color: '#eee', fontSize: 12, position: 'absolute', top: 28 }}>Автосервис, автотехцентр в
                    Москве</a>
                    <iframe title="Яндекс карты" src="https://yandex.ru/map-widget/v1/-/CCU6ULXFCB" height="400" frameBorder="1"
